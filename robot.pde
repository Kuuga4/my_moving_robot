...
void draw(){
  ...
  fill(102);              // 设置填充为灰色
  rect(x+40,y+17,20,6);     // 灰色条纹1
  rect(x+30,y+47,40,6);     // 灰色条纹2
  rect(x+20,y+77,60,6);     // 灰色条纹3
  ...
  ellipse(x+96,y-neckHeight+7,3,3);   // 小眼睛3
